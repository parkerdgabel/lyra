...
mod tests {
    ...
    fn test_string_literals() {
        ...
        assert_eq!(result, vec![TokenKind::String("hello".to_string()), TokenKind::Eof]);
    ...
    fn test_symbols() {
        ...
        assert_eq!(result, vec![TokenKind::Symbol("x".to_string()), TokenKind::Eof]);
        
        let result = tokenize_string("Symbol123").unwrap();
        assert_eq!(result, vec![TokenKind::Symbol("Symbol123".to_string()), TokenKind::Eof]);
    }
