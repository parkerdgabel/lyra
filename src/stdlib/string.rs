...
mod tests {
    ...
    fn test_string_length_wrong_args() {
        ...
        assert!(string_length(&[Value::String("".to_string()), Value::String("".to_string())]).is_err());
    }
    ...
    fn test_string_take_wrong_args() {
        ...
        assert!(string_take(&[Value::String("".to_string()), Value::Integer(1), Value::Integer(2)]).is_err());
    }
    ...
    fn test_string_take_wrong_types() {
        ...
        let args2 = vec![Value::String("Hello".to_string()), Value::String("1".to_string())];
