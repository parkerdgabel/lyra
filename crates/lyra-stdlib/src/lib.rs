...
pub fn register_all(ev: &mut Evaluator) {
    ...
    #[cfg(feature = "model")] model::register_model(ev);
    #[cfg(feature = "trace")] trace::register_trace(ev);
...
pub fn register_selected(ev: &mut Evaluator, names: &std::collections::HashSet<&str>) {
    ...
    #[cfg(feature = "model")] crate::model::register_model_filtered(ev, &predicate);
    #[cfg(feature = "trace")] crate::trace::register_trace_filtered(ev, &predicate);
    #[cfg(feature = "metrics")] crate::metrics::register_metrics_filtered(ev, &predicate);
