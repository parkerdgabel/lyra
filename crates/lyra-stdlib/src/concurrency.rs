...
pub fn register_concurrency(ev: &mut Evaluator) {
    ...
    #[cfg(feature = "tools")]
    add_specs(vec![
        tool_spec!("Future", summary: "Run expression asynchronously", params: ["expr","opts"], tags: ["concurrency","async"]),
        tool_spec!("Await", summary: "Wait for a Future to complete", params: ["future"], tags: ["concurrency","async"]),
        tool_spec!("ParallelMap", summary: "Map function over list in parallel", params: ["fn","list","opts"], tags: ["concurrency","parallel"]),
        tool_spec!("ParallelTable", summary: "Build table by mapping function in parallel", params: ["fn","list","opts"], tags: ["concurrency","parallel"]),
        ...
        tool_spec!("Scope", summary: "Run expression in bounded scope (threads/deadline)", params: ["opts","expr"], tags: ["concurrency","scope"]),
        tool_spec!("StartScope", summary: "Start a scope and return id", params: ["opts","expr"], tags: ["concurrency","scope"]),
        ...
        tool_spec!("TrySend", summary: "Try to send with optional timeout", params: ["channel","value","opts"], tags: ["concurrency","channel"], output_schema: Value::Assoc(HashMap::from([(String::from("type"), Value::String(String::from("boolean")))]))),
        tool_spec!("TryReceive", summary: "Try to receive with optional timeout", params: ["channel","opts"], tags: ["concurrency","channel"]),
